...
if __name__ == "__main__":
    ...
    if args.search_mode == "ingp2others":
        ...
        for stu in ['vm']:
            if stu == 'mlp':
                fea, fea_sc, sigma, color, rgb, lr = 0, 0.002, 0.002, 0.002, 1, 0.001
            else:
                fea, fea_sc, sigma, color, rgb, lr = 0, 0.002, 0.002, 0.002, 1, 0.01
            scene, tea_psnr, bound, scale, gamma = 'lego', 35, 1, 0.8, 0
            tea1 = './log/train_teacher/ingp/lego-pnsr35.0-449.49s/checkpoints/ngp_ep0200.pth'
            tea1 = './log/train_teacher/ingp/search_lego/lr0.01_ema_train-pnsr35.05/checkpoints/ngp_ep0500.pth'
